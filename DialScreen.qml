...
//    height: parent ? parent.height : 0
    ...
    Keypad{
        ...
        id: dialFour
        anchors.top: horizontalLine.bottom
        anchors.topMargin: parent.height*170/600
        anchors.left: verticalLine.right
        anchors.leftMargin: parent.width*250/1000
        keypadHeight: parent.height*50/600
        keypadWidth: keypadHeight
    ...
    Keypad{
        ...
        id: dialSeven
        anchors.top: horizontalLine.bottom
        anchors.topMargin: parent.height*240/600
        anchors.left: verticalLine.right
        anchors.leftMargin: parent.width*250/1000
        keypadHeight: parent.height*50/600
        keypadWidth: keypadHeight
    ...
    Keypad{
        ...
        id: dialAsh
        anchors.top: horizontalLine.bottom
        anchors.topMargin: parent.height*310/600
        anchors.left: verticalLine.right
        anchors.leftMargin: parent.width*250/1000
        keypadHeight: parent.height*50/600
        keypadWidth: keypadHeight
    ...
    Keypad{
        ...
        id: call
        anchors.top: horizontalLine.bottom
        anchors.topMargin: parent.height*380/600
        anchors.left: verticalLine.right
        anchors.leftMargin: parent.width*350/1000
        keypadHeight: parent.height*50/600
        keypadWidth: keypadHeight
...
Rectangle{
    id: borderLine
    anchors.bottom: dialOne.top
    anchors.bottomMargin: 15
    anchors.left: dialOne.left
    ...
    Flickable {
        ...
        anchors.left: verticalLine.right
        anchors.leftMargin: parent.width*300/1000

        width: parent.width*140/1000;
        ...
        TextEdit {
            ...
            color: "white"
            font.bold: true
            font.pixelSize: flick.height*23/28
