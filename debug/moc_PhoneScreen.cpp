...
QT_MOC_LITERAL(5, 44, 6) // "onBack"
    ...
    "PhoneScreen\0onRefresh\0\0value\0"
...
void PhoneScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PhoneScreen *_t = static_cast<PhoneScreen *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject PhoneScreen::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PhoneScreen.data,
      qt_meta_data_PhoneScreen,  qt_static_metacall, nullptr, nullptr}
};
...
void *PhoneScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PhoneScreen.stringdata0))
        return static_cast<void*>(const_cast< PhoneScreen*>(this));
